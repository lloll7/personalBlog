...

  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: "添加文章", icon: "el-icon-data-line", auth: true },
      },
      {
        path: "/editBlog/:id",
        name: "EditBlog",
        ...
        meta: { title: "编辑文章", icon: "el-icon-data-line", auth: true },
      },
    ],
  },

  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: "添加项目", icon: "el-icon-data-line", auth: true },
      },
    ],
  },
    ...
    children: [
      {
        ...
        meta: { title: "评论管理", icon: "el-icon-edit", auth: true },
      },
    ],
  },
    ...
    children: [
      {
        ...
        meta: { title: "留言板", icon: "el-icon-connection", auth: true },
      },
    ],
  },
